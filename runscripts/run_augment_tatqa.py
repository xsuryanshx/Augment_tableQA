...
--prompt_file templates/prompts/tatqa_augment_ic.txt \
--system_prompt_file templates/prompts/tatqa_augment_system.txt \
...
--dataset_split {DATASPLIT} \
--sql_prompt_file templates/prompts/tatqa_sql_ic.txt \
